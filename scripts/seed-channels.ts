...
const seeds: Array<{
  ...
  { name: "Associated Press", handle: "@AssociatedPress", medium: "youtube", entity_type: "org", official_url: "https://apnews.com", language: "en", country: "US" },
  ...
  { name: "News24", handle: "@News24thinkfirst", medium: "youtube", entity_type: "org", language: "hi", country: "IN" },
  ...
  { name: "The Wire", handle: "@TheWireNews", medium: "youtube", entity_type: "org", official_url: "https://thewire.in", language: "en", country: "IN" },
  ...
  { name: "Scroll.in", handle: "@ScrollIn", medium: "youtube", entity_type: "org", official_url: "https://scroll.in", language: "en", country: "IN" },
  ...
  { name: "Hindustan Times", handle: "@HT-Videos", medium: "youtube", entity_type: "org", official_url: "https://www.hindustantimes.com", language: "en", country: "IN" },
  ...
  { name: "Ravish Kumar Official", handle: "@ravishkumar.official", medium: "youtube", entity_type: "individual", language: "hi", country: "IN" },
  { name: "Peek TV", handle: "@PeekTVOfficial", medium: "youtube", entity_type: "org", language: "hi", country: "IN" },
  { name: "Soch by Mohak Mangal", handle: "@mohak_mangal", medium: "youtube", entity_type: "individual", language: "hi", country: "IN" },
  ...
  { name: "Abhisar Sharma", handle: "@Abhisar_Sharma", medium: "youtube", entity_type: "individual", language: "hi", country: "IN" },
  { name: "Faye D'Souza", handle: "@FayeDSouza", medium: "youtube", entity_type: "individual", language: "en", country: "IN" },
  { name: "Barkha Dutt", handle: "@mojostory", medium: "youtube", entity_type: "individual", language: "en", country: "IN" },
  { name: "Prashant Dhawan", handle: "@worldaffairsunacademy", medium: "youtube", entity_type: "individual", language: "en", country: "IN" },
  { name: "Kumar Shyam", handle: "@KumarShyam", medium: "youtube", entity_type: "individual", language: "hi", country: "IN" },
  { name: "Satya Hindi", handle: "@SatyaHindi", medium: "youtube", entity_type: "org", official_url: "https://www.satyahindi.com", language: "hi", country: "IN" },
  { name: "Ajit Anjum", handle: "@AjitAnjumOfficial", medium: "youtube", entity_type: "individual", language: "hi", country: "IN" },
];
