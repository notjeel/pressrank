...
const LANGUAGES = [
  ...
  { code: "mni", label: "Manipuri (मणिपूरी)" },
    ...
    <>
      <style>{`
        @media (max-width: 680px) {
          ...
          .pr-header-right .pr-auth-btn { display: none !important; }
        }
        ...
        @media (max-width: 440px) {
          .pr-logo-text { display: none !important; }
        }
      `}</style>
        ...
        >
          ...
          <div style={{ flex: 1, display: "flex", alignItems: "center" }}>
            ...
            >
              ...
              />
              <span className="pr-logo-text" style={{ fontWeight: 700, fontSize: 17, letterSpacing: "-.025em", color: "var(--fg)" }}>
                PressRank
              </span>
            </Link>
          </div>
